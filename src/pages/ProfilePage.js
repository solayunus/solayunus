            ...
            <Row>
              <Col lg="6" md="6">
                ...
                <p className="profile-description">
                   An experienced information technology consultant with a demonstrated history of working in the IT industries.
                  Highly skilled in Software Development, Cybersecurity, Cloud Computing, System Administration, Microsoft 365 Admin, Google Suite Admin, Customer service, and IT Support.
                </p>
              ...
              <Col className="ml-auto mr-auto" lg="4" md="6">
                <Card className="card-coin card-plain">
                  <CardHeader>
                    ...
                    />
                    <h4 className="title">Software Developer | IT Security Expert</h4>
                  </CardHeader>
                  <CardBody>
                    <Nav
                      ...
                      <TabPane tabId="tab3">
                        <Table className="tablesorter" responsive>
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td>The easy approach to learning how to code </td>
                            </tr>
                          </tbody>
                        </Table>
                      </TabPane>
